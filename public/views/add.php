...
<head>
    ...
    <script type="text/javascript" defer src="public/scripts/add.js"></script>
    ...
    <main>
        ...
        <div>
            <div class="add-container">
                ...
                <input id="title-input" maxlength="50" type="text"
                       placeholder="Be precise, a good example is ['word' in European languages]">
